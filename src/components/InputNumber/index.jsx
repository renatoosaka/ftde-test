...
const InputNumber = forwardRef(({ className, label, placeholder, name, suffix, defaultValue }, ref) => {
  ...
  return (
    <S.InputNumberWrapper className={className}>
      ...
      <S.InputContent>
        <S.Input type="number" placeholder={placeholder} name={name} defaultValue={numberValue} ref={ref}/>
